...
export class Line {
    ...
    public static doPointsIntersect(p1: Point, q1: Point, p2: Point, q2: Point): boolean {
    ...
    public static doIntersect(a: Line, b: Line): boolean {
...
export class Rectangle {
    ...
    public topRightPoint!: Point;
    public bottomLeftPoint!: Point;
    ...
    public static doOverlap(rectangle1: Rectangle, rectangle2: Rectangle): boolean {
    ...
    public static printIntersections(rectangle1: Rectangle, rectangle2: Rectangle) {
    ...
    public static isAdjacent(rectangle1: Rectangle, rectangle2: Rectangle): boolean {
        //adjacent (sub-line/proper/partial)
    ...
    public static printAdjacentType(a: Line, b: Line) {
    ...
    public static isSubLine(a: Line, b: Line): boolean {
        let smaller: Line;
        let larger: Line;
    ...
    public static isProperAdjacent(a: Line, b: Line): boolean {
    ...
    public static isContainment(rectangle1: Rectangle, rectangle2: Rectangle): boolean {
...
let l1: Point = new Point(0, 10), r1 = new Point(10, 0);
let l2: Point = new Point(2, 15), r2 = new Point(8, 1);
let rectangle1: Rectangle = new Rectangle(l1, r1), rectangle2: Rectangle = new Rectangle(l2, r2);
